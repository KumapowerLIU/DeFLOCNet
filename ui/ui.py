...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(320, 250, 81, 27))
        ...
        self.pushButton_8.setGeometry(QtCore.QRect(130, 40, 97, 27))
        self.pushButton_8.setObjectName("pushButton_8")

        self.pushButton_9 = QtWidgets.QPushButton(Form)
        self.pushButton_9.setGeometry(QtCore.QRect(250, 40, 97, 27))
        self.pushButton_9.setObjectName("pushButton_9")

        self.pushButton_10 = QtWidgets.QPushButton(Form)
        self.pushButton_10.setGeometry(QtCore.QRect(370, 40, 97, 27))
        self.pushButton_10.setObjectName("pushButton_10")

        self.graphicsView = QtWidgets.QGraphicsView(Form)
        self.graphicsView.setGeometry(QtCore.QRect(20, 120, 256, 256))
        self.graphicsView.setObjectName("graphicsView")
        self.graphicsView_2 = QtWidgets.QGraphicsView(Form)
        self.graphicsView_2.setGeometry(QtCore.QRect(450, 120, 256, 256))
        ...
        self.pushButton_9.clicked.connect(Form.nature)
        self.pushButton_10.clicked.connect(Form.face)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Learning Semantic Imgae Manipulation from Low-level Controls"))
        ...
        self.pushButton_9.setText(_translate("Form", "Nature"))
        self.pushButton_10.setText(_translate("Form", "Face"))
